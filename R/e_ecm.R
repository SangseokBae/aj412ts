...
cat("# we should actually use test statistics from Engle & Granger (1987) or Engle & Yoo (1987)  ", '\n')
cat("# able to reject null of unit root in the residual - they are cointegrated  ", '\n')
cat("  ", '\n')
...
cat("# Note that the alpha is insignificant and close to zero  ", '\n')
...
cat("# Note that the alpha is negative and significant, so silver does all the work  ", '\n')
